...
export interface ContextMessageUpdate<S = {}> extends Context<S> {

  answerCbQuery: (message?: string, options?: any) => any;
   ...
   */
  reply(text: string, extra?: ExtraEditMessage): Promise<Message>
...
export type Middleware<S = any> = (ctx: ContextMessageUpdate<S>, next: () => Promise<any>) => Promise<any>;
...
export class Telegraf {
  telegram: Telegram;
  options: any;
  start(middleware: any): any;
  help(middleware: any): any;
   ...
   */
  on(updateTypes: UpdateType | UpdateType[], middleware: Middleware, ...middlewares: Middleware[]): any
   ...
   * @param middlewares Middleware functions
   */
  hears(triggers: HearsTriggers, middleware: Middleware, ...middlewares: Middleware[]): any
   ...
   */
  command(command: string | string[], middleware: Middleware, ...middlewares: Middleware[]): any

  /**
   * Registers middleware for handling callback_data actions with game query.
   * @param middlewares Middleware functions
   */
  gameQuery(middleware: Middleware, ...middlewares: Middleware[]): any
   ...
   */
  startPolling(timeout?: number, limit?: number, allowedUpdates?: UpdateType[]): any
   ...
   * @param host Hostname
   */
  startWebhook(webhookPath: string, tlsOptions: TlsOptions, port: number, host?: string): any
   ...
   * @param webhookPath Webhook url path (see Telegraf.setWebhook)
   */
  webhookCallback(webhookPath: string): (req: IncomingMessage, res: any) => void
   ...
   */
  handleUpdate(rawUpdate: Update, webhookResponse?: any): any
